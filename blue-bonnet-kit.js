...
// Published explicitly. A top-level `const` is visible to other <script> tags
// but NOT on window, so any host that loads this as a module, in a sandbox, or
// from another scope finds nothing there. This is the difference between
// "drop it in" and "drop it in and hope".
if (typeof window !== "undefined") window.BBKit = BBKit;
if (typeof globalThis !== "undefined") globalThis.BBKit = BBKit;
if (typeof module !== "undefined" && module.exports) module.exports = BBKit;
